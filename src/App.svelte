...
<main class="flex flex-col justify-between h-screen " style="background-image: url(https://wallpapercave.com/wp/wp7368676.jpg);">
 <Navbar></Navbar>
 <div class="warning-content flex flex-col justify-center items-center bg-blue-600 w-96 opacity-80">
  ...
  <footer class="footer footer-center p-10 bg-primary text-primary-content">
    <div>
      ...
      <p class="font-bold">
        Vsvai.com <br>Providing reliable tech help and consultancy
      </p> 
